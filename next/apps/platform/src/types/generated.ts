...
// Generated on: 2026-09-13T17:13:26.903Z
...
export type ProjectsCreate = Omit<Projects, '$id' | '$createdAt' | '$updatedAt' | '$sequence'>;
...
export type ProjectsInput = Omit<Projects, '$id' | '$createdAt' | '$updatedAt' | '$permissions' | '$sequence' | '$collection' | '$tenant'>;
