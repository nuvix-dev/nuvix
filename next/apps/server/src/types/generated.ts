...
export type UsersCreate = Omit<Users, '$id' | '$createdAt' | '$updatedAt' | '$sequence'>
...
export type SessionsCreate = Omit<Sessions, '$id' | '$createdAt' | '$updatedAt' | '$sequence'>
...
export type TokensCreate = Omit<Tokens, '$id' | '$createdAt' | '$updatedAt' | '$sequence'>
...
export type AuthenticatorsPick<K extends keyof Authenticators> = Pick<Authenticators, K>
export type AuthenticatorsOmit<K extends keyof Authenticators> = Omit<Authenticators, K>

// Utility types for Challenges
export type ChallengesCreate = Omit<Challenges, '$id' | '$createdAt' | '$updatedAt' | '$sequence'>
...
export type IdentitiesCreate = Omit<Identities, '$id' | '$createdAt' | '$updatedAt' | '$sequence'>
...
export type TargetsCreate = Omit<Targets, '$id' | '$createdAt' | '$updatedAt' | '$sequence'>
...
export type TeamsCreate = Omit<Teams, '$id' | '$createdAt' | '$updatedAt' | '$sequence'>
...
export type MembershipsCreate = Omit<Memberships, '$id' | '$createdAt' | '$updatedAt' | '$sequence'>
