...
import { AUTH_SCHEMA, bootstrapAuthSchema, createAuthDatabase, ensureAuthSchema } from './schema'
...
describe.skipIf(!hasDocker)('bootstrapAuthSchema (live nuvix/postgres:18.1)', () => {
