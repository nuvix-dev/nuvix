...
- [x] Remaining platform slices: extended project configuration (services, APIs, OAuth2, SMTP, JWTs), metadata (`/projects/:projectId/metadata/exposed-schemas`), and templates
