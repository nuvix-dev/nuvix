  ...
  return {
    '@nestjs/swagger': {
      models: [
        ...
        [
          import('./schema/collections/DTO/attributes.dto'),
          {
            CreateStringAttributeDTO: {
              ...
              required: { required: false, type: () => Boolean, default: null },
              default: {
                required: false,
                type: () => String,
                nullable: true,
            ...
            CreateIntegerAttributeDTO: {
              min: { required: false, type: () => Number, default: null },
              max: { required: false, type: () => Number, default: null },
              default: { required: false, type: () => Number, default: null },
            },
            CreateFloatAttributeDTO: {},
            CreateBooleanAttributeDTO: {
              default: { required: false, type: () => Boolean, default: null },
            },
            ...
            CreateRelationAttributeDTO: {
              ...
              key: { required: true, type: () => String },
              twoWayKey: { required: false, type: () => String, default: null },
              onDelete: { required: true, type: () => String },
            },
            UpdateStringAttributeDTO: {
              newKey: { required: false, type: () => String, default: null },
            },
        ...
        [
          import('./schema/collections/DTO/indexes.dto'),
          {
            CreateIndexDTO: {
              ...
              orders: { required: true, type: () => [String] },
            },
          },
        ],
        [
        ...
        [
          import('./account/DTO/token.dto'),
          {
            ...
            CreateMagicURLTokenDTO: {
              userId: { required: true, type: () => String, maxLength: 36 },
              email: { required: true, type: () => String, format: 'email' },
        ...
        [
          import('./base/entities/base.entity'),
