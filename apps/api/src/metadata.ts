...
export default async () => {
  const t = {
    ['../../../libs/utils/src/constants']: await import(
      '../../../libs/utils/src/constants'
    ),
  };
  return {
    '@nestjs/swagger': {
      models: [
        [
          import('./databases/DTO/create-schema.dto'),
          {
            CreateSchema: {
              ...
              type: {
                required: true,
                enum: t['../../../libs/utils/src/constants'].SchemaType,
              },
            },
          },
        ],
        ...
        [
          import('./account/identities/DTO/identity.dto'),
          {
            IdentityIdParamDTO: {
        ...
        [
          import('./account/mfa/DTO/mfa.dto'),
          {
            UpdateAccountMfaDTO: {
              mfa: { required: true, type: () => Boolean },
            },
        ...
        [
          import('./account/recovery/DTO/recovery.dto'),
          {
            CreateRecoveryDTO: {
              email: { required: true, type: () => String, format: 'email' },
        ...
        [
          import('./account/sessions/DTO/session.dto'),
          {
        ...
        [
          import('./account/sessions/DTO/token.dto'),
          {
        ...
        [
          import('./account/targets/DTO/target.dto'),
          {
            CreatePushTargetDTO: {
              targetId: { required: true, type: () => String },
      ...
      controllers: [
        ...
        [
          import('./account/identities/identity.controller'),
          { IdentityController: { getIdentities: {}, deleteIdentity: {} } },
        ],
        [
          import('./account/mfa/mfa.controller'),
          {
            MfaController: {
        ...
        [
          import('./account/recovery/recovery.controller'),
          {
            RecoveryController: {
        ...
        [
          import('./account/sessions/session.controller'),
          {
            SessionsController: {
              getSessions: {},
              deleteSessions: {},
        ...
        [
          import('./account/targets/targets.controller'),
          {
            TargetsController: {
              createPushTarget: {},
              updatePushTarget: {},
