Create a new file. Before using this route, you should create a new bucket resource using either a [server integration](https://docs.nuvix.in/server/storage#storageCreateBucket) API or directly from your Nuvix console.
