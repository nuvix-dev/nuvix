...
export class Auth {
  ...
  public static tokenVerify(tokens: TokenDocument[], type: number | null, secret: string): TokenDocument | false {
  ...
  public static sessionVerify(sessions: SessionDocument[], secret: string): string | false {
  ...
  public static getRoles(user: UserDocument, requestRoles: string[]): string[] { // requestRoles : Roles From current Request.
    const roles: string[] = [];
  ...
  public static isAnonymousUser(user: UserDocument): boolean {
