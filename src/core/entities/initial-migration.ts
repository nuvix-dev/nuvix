...
export class InitialMigration implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "meta"."variables" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "resourceType" character varying(100) NOT NULL, "resourceInternalId" character varying(255), "resourceId" character varying(255), "key" character varying(255), "value" character varying(8192) NOT NULL, CONSTRAINT "PK_5d96fc94b21c1f1a722d53b55eb" PRIMARY KEY ("id", "_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "meta"."stats" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "metric" character varying(255) NOT NULL, "region" character varying(255) NOT NULL, "value" integer NOT NULL, "time" TIMESTAMP WITH TIME ZONE, "period" character varying(4) NOT NULL, CONSTRAINT "PK_e37774a2ff6937100b419aade1b" PRIMARY KEY ("id", "_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "meta"."databases" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "name" character varying(256) NOT NULL, "enabled" boolean DEFAULT true, CONSTRAINT "PK_9d832d81be6155d1752699b1fa3" PRIMARY KEY ("id", "_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_4f56ebcf8cba238205136aa00f" ON "meta"."databases" ("name") `);
        await queryRunner.query(`CREATE TABLE "auth"."tokens" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "userId" integer, "type" integer NOT NULL, "secret" character varying(512), "expire" TIMESTAMP, "userAgent" character varying(16384), "ip" character varying(45), "user_$id" character varying, CONSTRAINT "PK_8b4dacf4b62b762adfd0fc46c5f" PRIMARY KEY ("id", "_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_8c26f11a8b165c263af3ad865f" ON "auth"."tokens" ("userId", "user_$id") `);
        await queryRunner.query(`CREATE TABLE "auth"."authenticators" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "userId" integer, "type" character varying(255), "verified" boolean DEFAULT false, "data" text, "user_$id" character varying, CONSTRAINT "PK_fbf0ff7de4a02e12ab2c94b976d" PRIMARY KEY ("id", "_id"))`);
        await queryRunner.query(`CREATE TABLE "auth"."challenges" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "userId" integer, "type" character varying(255), "token" character varying(512), "code" character varying(512), "expire" TIMESTAMP WITH TIME ZONE, "user_$id" character varying, CONSTRAINT "PK_da8d12f2ef5e21bc8d140d5be7c" PRIMARY KEY ("id", "_id"))`);
        await queryRunner.query(`CREATE INDEX "idx_user_id" ON "auth"."challenges" ("userId", "user_$id") `);
        await queryRunner.query(`CREATE TABLE "auth"."sessions" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "userId" integer, "provider" character varying(128), "providerUid" character varying(2048), "providerAccessToken" character varying(16384), "providerAccessTokenExpiry" TIMESTAMP WITH TIME ZONE, "providerRefreshToken" character varying(16384), "secret" character varying(512), "userAgent" character varying(16384), "ip" character varying(45), "countryCode" character varying(2), "osCode" character varying(256), "osName" character varying(256), "osVersion" character varying(256), "clientType" character varying(256), "clientCode" character varying(256), "clientName" character varying(256), "clientVersion" character varying(256), "clientEngine" character varying(256), "clientEngineVersion" character varying(256), "deviceName" character varying(256), "deviceBrand" character varying(256), "deviceModel" character varying(256), "factors" text, "expire" TIMESTAMP WITH TIME ZONE NOT NULL, "mfaUpdatedAt" TIMESTAMP WITH TIME ZONE, "user_$id" character varying, CONSTRAINT "PK_04cc870d3c946ab416ad3a2170a" PRIMARY KEY ("id", "_id"))`);
        await queryRunner.query(`CREATE TABLE "auth"."teams" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "name" character varying(128), "total" integer, "prefs" json DEFAULT '{}', CONSTRAINT "PK_6ea27d304b8980f1cd9b3a4401b" PRIMARY KEY ("id", "_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "auth"."memberships" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "userId" integer, "teamId" integer, "roles" character varying(128) array, "invited" TIMESTAMP WITH TIME ZONE, "joined" TIMESTAMP WITH TIME ZONE, "confirm" boolean, "secret" character varying(256), "user_$id" character varying, "team_$id" character varying, CONSTRAINT "PK_a47b82f74c5be0758db5178413b" PRIMARY KEY ("id", "_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "storage"."buckets" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "enabled" boolean NOT NULL DEFAULT true, "name" character varying(128) NOT NULL, "fileSecurity" boolean NOT NULL DEFAULT false, "maximumFileSize" integer NOT NULL, "allowedFileExtensions" text NOT NULL, "compression" character varying(10) NOT NULL, "encryption" boolean NOT NULL DEFAULT true, "antivirus" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_d698f23b3b6f7d6aab06787ad6f" PRIMARY KEY ("id", "_id"))`);
        await queryRunner.query(`CREATE TABLE "storage"."files" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "bucketId" integer NOT NULL, "name" character varying(2048) NOT NULL, "path" character varying(2048) NOT NULL, "signature" character varying(2048) NOT NULL, "mimeType" character varying(255) NOT NULL, "metadata" character varying(75000) NOT NULL, "sizeOriginal" integer NOT NULL, "sizeActual" integer NOT NULL, "algorithm" character varying(255) NOT NULL, "comment" character varying(2048) NOT NULL, "openSSLVersion" character varying(64) NOT NULL, "openSSLCipher" character varying(64) NOT NULL, "openSSLTag" character varying(2048) NOT NULL, "openSSLIV" character varying(2048) NOT NULL, "chunksTotal" integer NOT NULL, "chunksUploaded" integer NOT NULL, "bucket_$id" character varying, CONSTRAINT "PK_01c743f72ddc07505b4e4749031" PRIMARY KEY ("id", "_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "messages"."subscribers" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "targetId" character varying(128) NOT NULL, "targetInternalId" character varying(128) NOT NULL, "userId" character varying(128) NOT NULL, "userInternalId" character varying(128) NOT NULL, "topicId" character varying(128) NOT NULL, "topicInternalId" character varying(128) NOT NULL, "providerType" character varying(128) NOT NULL, CONSTRAINT "PK_ffac45a68919b469d61c155018c" PRIMARY KEY ("id", "_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "functions"."builds" ("id" SERIAL NOT NULL, "_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permissions" character varying(255) array NOT NULL DEFAULT '{}', "search" character varying(16384), "startTime" TIMESTAMP WITH TIME ZONE, "endTime" TIMESTAMP WITH TIME ZONE, "duration" integer, "size" integer, "deploymentInternalId" character varying(255), "deploymentId" character varying(255), "runtime" character varying(2048) NOT NULL, "status" character varying(256) NOT NULL DEFAULT 'processing', "path" character varying(2048), "logs" character varying(1000000), "sourceType" character varying(2048) NOT NULL DEFAULT 'local', "source" character varying(2048) NOT NULL, CONSTRAINT "PK_7ecf9493eb7d89044dac7e8912a" PRIMARY KEY ("id", "_id"))`);
        await queryRunner.query(`CREATE INDEX "_key_deployment" ON "functions"."builds" ("deploymentId") `);
        await queryRunner.query(`ALTER TABLE "auth"."tokens" ADD CONSTRAINT "FK_8c26f11a8b165c263af3ad865f8" FOREIGN KEY ("userId", "user_$id") REFERENCES "auth"."users"("id","_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auth"."authenticators" ADD CONSTRAINT "FK_2f3a0e7f07ebe75b1a85fbc0e18" FOREIGN KEY ("userId", "user_$id") REFERENCES "auth"."users"("id","_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auth"."challenges" ADD CONSTRAINT "FK_fec373b440cc69f2abfa95eaf49" FOREIGN KEY ("userId", "user_$id") REFERENCES "auth"."users"("id","_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auth"."sessions" ADD CONSTRAINT "FK_3f4cee83dc7df0ef302718cbfce" FOREIGN KEY ("userId", "user_$id") REFERENCES "auth"."users"("id","_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
