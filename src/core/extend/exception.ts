...
export class Exception extends HttpException {
    ...
    static readonly USER_ANONYMOUS_CONSOLE_PROHIBITED = 'user_anonymous_console_prohibited';
    ...
    static readonly USER_AUTHENTICATOR_ALREADY_VERIFIED = 'user_authenticator_already_verified';
    static readonly USER_RECOVERY_CODES_ALREADY_EXISTS = 'user_recovery_codes_already_exists';
    static readonly USER_RECOVERY_CODES_NOT_FOUND = 'user_recovery_codes_not_found';
    ...
    static readonly STORAGE_FILE_TYPE_UNSUPPORTED = 'storage_file_type_unsupported';
    ...
    static readonly STORAGE_BUCKET_ALREADY_EXISTS = 'storage_bucket_already_exists';
    static readonly STORAGE_BUCKET_NOT_FOUND = 'storage_bucket_not_found';
    static readonly STORAGE_INVALID_CONTENT_RANGE = 'storage_invalid_content_range';
    ...
    static readonly PROVIDER_REPOSITORY_NOT_FOUND = 'provider_repository_not_found';
    static readonly REPOSITORY_NOT_FOUND = 'repository_not_found';
    static readonly PROVIDER_CONTRIBUTION_CONFLICT = 'provider_contribution_conflict';
    ...
    static readonly ATTRIBUTE_DEFAULT_UNSUPPORTED = 'attribute_default_unsupported';
    ...
    static readonly PROJECT_TEMPLATE_DEFAULT_DELETION = 'project_template_default_deletion';
    ...
    /** Realtime */
    static readonly REALTIME_MESSAGE_FORMAT_INVALID = 'realtime_message_format_invalid';
    ...
    constructor(
        ...
        const parsedCode = typeof errorCode === 'string' && !isNaN(Number(errorCode)) ? parseInt(errorCode) : errorCode;
...
const errorCodes: Record<string, ErrorCode> = {
    ...
    [Exception.GENERAL_UNKNOWN_ORIGIN]: {
        ...
        description: 'The request originated from an unknown origin. If you trust this domain, please list it as a trusted platform in the Nuvix console.',
        code: 403,
    },
    [Exception.GENERAL_API_DISABLED]: {
        name: Exception.GENERAL_API_DISABLED,
        description: 'The requested API is disabled. You can enable the API from the Nuvix console.',
        code: 403,
    },
    [Exception.GENERAL_SERVICE_DISABLED]: {
        name: Exception.GENERAL_SERVICE_DISABLED,
        description: 'The requested service is disabled. You can enable the service from the Nuvix console.',
        code: 403,
    },
    ...
    [Exception.GENERAL_SMTP_DISABLED]: {
        ...
        description: 'SMTP is disabled on your Nuvix instance. You can <a href="/docs/email-delivery">learn more about setting up SMTP</a> in our docs.',
        code: 503,
    },
    [Exception.GENERAL_PHONE_DISABLED]: {
        name: Exception.GENERAL_PHONE_DISABLED,
        description: 'Phone provider is not configured. Please check the _APP_SMS_PROVIDER environment variable of your Nuvix server.',
        code: 503,
    },
    ...
    [Exception.GENERAL_USAGE_DISABLED]: {
        ...
        description: 'Usage stats is not configured. Please check the value of the _APP_USAGE_STATS environment variable of your Nuvix server.',
        code: 501,
    },
    [Exception.GENERAL_NOT_IMPLEMENTED]: {
        name: Exception.GENERAL_NOT_IMPLEMENTED,
        description: 'This method was not fully implemented yet. If you believe this is a mistake, please upgrade your Nuvix server version.',
        code: 405,
    },
    ...
    [Exception.USER_COUNT_EXCEEDED]: {
        ...
        'description': 'The current project has exceeded the maximum number of users. Please check your user limit in the Nuvix console.',
        'code': 400,
    },
    ...
    [Exception.USER_JWT_INVALID]: {
        ...
        'description': 'The JWT token is invalid. Please check the value of the X-Nuvix-JWT header to ensure the correct token is being used.',
        'code': 401,
    },
    ...
    [Exception.USER_BLOCKED]: {
        ...
        'description': 'The current user has been blocked. You can unblock the user by making a request to the User API\'s "Update User Status" endpoint or in the Nuvix Console\'s Auth section.',
        'code': 401,
    },
    ...
    [Exception.USER_AUTH_METHOD_UNSUPPORTED]: {
        ...
        'description': 'The requested authentication method is either disabled or unsupported. Please check the supported authentication methods in the Nuvix console.',
        'code': 501,
        'publish': false,
    },
    ...
    [Exception.USER_API_KEY_AND_SESSION_SET]: {
        ...
        'description': 'API key and session used in the same request. Use either `setSession` or `setKey`. Learn about which authentication method to use in the SSR docs: https://nuvix.io/docs/products/auth/server-side-rendering',
        'code': 403,
    },
    ...
    [Exception.STORAGE_INVALID_NUVIX_ID]: {
        ...
        'description': 'The value for x-nuvix-id header is invalid. Please check the value of the x-nuvix-id header is a valid id and not unique().',
        'code': 400,
    },
    ...
    [Exception.FUNCTION_ENTRYPOINT_MISSING]: {
        'name': Exception.FUNCTION_RUNTIME_UNSUPPORTED,
        'description': 'Entrypoint for your Nuvix Function is missing. Please specify it when making deployment or update the entrypoint under your function\'s "Settings" > "Configuration" > "Entrypoint".',
        'code': 404,
    },
    ...
    [Exception.PROJECT_NOT_FOUND]: {
        ...
        'description': 'Project with the requested ID could not be found. Please check the value of the X-Nuvix-Project header to ensure the correct project ID is being used.',
        'code': 404,
    },
    ...
    [Exception.PROJECT_PROVIDER_DISABLED]: {
        ...
        'description': 'The chosen OAuth provider is disabled. You can enable the OAuth provider using the Nuvix console.',
        'code': 412,
    },
    ...
    [Exception.PROJECT_KEY_EXPIRED]: {
        ...
        'description': 'The project key has expired. Please generate a new key using the Nuvix console.',
        'code': 401,
    },
    ...
    [Exception.ROUTER_DOMAIN_NOT_CONFIGURED]: {
        ...
        'description': '_APP_DOMAIN, _APP_DOMAIN_TARGET, and _APP_DOMAIN_FUNCTIONS environment variables have not been configured. Please configure the domain environment variables before accessing the Nuvix Console via any IP address or hostname other than localhost. This value could be an IP like 203.0.113.0 or a hostname like example.com.',
        'code': 500,
    },
    ...
    [Exception.MIGRATION_IN_PROGRESS]: {
        ...
        'description': 'Migration is already in progress. You can check the status of the migration in your Nuvix Console\'s "Settings" > "Migrations".',
        'code': 409,
    },
