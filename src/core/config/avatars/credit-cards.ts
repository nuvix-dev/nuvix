...
const assetsPath = path.resolve(__dirname, '../../../../assets/avatars/credit-cards');
...
export const creditCards = {
    ...
    'targeta-shopping': { 'name': 'Tarjeta Shopping', 'path': assetsPath + `/tarjeta-shopping.png` },
    'union-china-pay': { 'name': 'Union China Pay', 'path': assetsPath + `/union-china-pay.png` },
