...
export class OrganizationsController {
  ...
  @Patch(':id/payment-method/backup')
  /**
   * @todo Implement this method.
  ...
  @Delete(':id/payment-method/backup')
  /**
   * @todo Implement this method.
  ...
  @Get(':id/payment-methods/:methodId')
  /**
   * @todo Implement this method.
  ...
  @Get(':id/billing-address/:addressId')
  /**
   * @todo Implement this method.
  ...
  @Get(':id/invoices/:invoiceId/view')
  /**
   * @todo Implement this method.
